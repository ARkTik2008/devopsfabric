...
cp --force dmitriy.fabric.baikalteam.com.conf /etc/nginx/conf.d/dmitriy.fabric.baikalteam.com.conf

# checking && reloading NGINX config
nginx -t && nginx -s reload

# adding directiry for new virtual server
mkdir -p /var/www/dmitriy.fabric.baikalteam.com/html

# copiing index.html and hello.html
cp --force {index.html,hello.html} /var/www/dmitriy.fabric.baikalteam.com/html/
